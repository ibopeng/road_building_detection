...
im_raw_trn, lb_raw_trn = dp.load_data('../data_sub/train', num_rawIm_trn)
im_raw_val, lb_raw_val = dp.load_data('../data_sub/valid', num_rawIm_val_inf)
...
with tf.Session(graph = graph) as sess:
    ...
    im_patch_val, lb_patch_val = dp.data_patch(im_norm_val,
                                               lb_norm_val,
                                               patch_cpt_val,
                                               im_patch_width,
                                               im_patch_height,
    ...
    for ep in range(num_epochs):
        ...
        for it in range(num_iterations):
            ...
            if it % 100 == 0:
                ...
                Feed_Dict_Val = {x: im_patch_val, y_true: lb_patch_val}
